...
export default function Gallery() {
    ...
    const getTechCardData = (cellId) => {
        const techData = {
            cell1: {
                title: 'Black Lodge Brews',
                items: ['Floating navigation with smooth scroll triggers', 'Gradient colors on backgrounds and hero font', 'Particle system for fireflies and beer & foam fizz', 'Animated beer-fill elements', 'Scroll-triggered data updates', 'Liquid card animation', 'Background image parallax scrolling', 'Interactive map interface']
            },
            cell2: {
